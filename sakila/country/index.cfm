<cfoutput>
    ...
    <cfset variables.qCountry = new components.countryGateaway().list(
        page =url.page,
        ...
        <div class ="">
            ...
            <nav data-mdb-navbar-init class="navbar navbar-expand-lg bg-body-tertiary">
                ...
                <div class="container">
                    <cfset variables.columns = [
                        ...
                        },
                        {
                           ...
                           "classes": "text-center",
                           "content":(country)=> {
                               return '<a href ="country-add-edit.cfm?id=#country.country_id# " class ="text-decoration-none">Edit</a>'
                ...
                <div class="d-flex justify-content-center mt-3 mb-3">
                    <button class="border rounded px-5 btn btn-primary "><a href="country-add-edit.cfm" class ="text-white text-decoration-none" >INSERT</a></button>
                </div>
